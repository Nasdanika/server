...
public class EClassifierBoxImpl extends CDOObjectImpl implements EClassifierBox {
	 ...
	 * @generated NOT
	 */
	public EClassifier get(Context context) {
		return cdoView().getSession().getPackageRegistry().getEPackage(getNsURI()).getEClassifier(getName());
	}
	 ...
	 * @generated NOT
	 */
	public void set(EClassifier value, Context context) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case BoxingPackage.ECLASSIFIER_BOX___SET__OBJECT_CONTEXT:
				set((EClassifier)arguments.get(0), (Context)arguments.get(1));
				return null;
		}
