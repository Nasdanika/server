...
public class SerializableBoxImpl extends CDOObjectImpl implements SerializableBox {
	 ...
	 * @generated NOT
	 */
	public Serializable get(final Context context) {
		try {
			ObjectInputStream ois = new ObjectInputStream(new ByteArrayInputStream(getValue())) {
				...
				protected Object resolveObject(Object obj) throws IOException {
					if (obj instanceof CDOID) {
						return cdoView().getObject((CDOID) obj);
					}
					return obj;
				}
	 ...
	 * @generated NOT
	 */
	public void set(Serializable value, final Context context) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case BoxingPackage.SERIALIZABLE_BOX___SET__OBJECT_CONTEXT:
				set((Serializable)arguments.get(0), (Context)arguments.get(1));
				return null;
		}
