...
public class BoxingFactoryImpl extends EFactoryImpl implements BoxingFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BoxingPackage.LIST_BOX: return (EObject)createListBox();
			case BoxingPackage.MAP_BOX: return (EObject)createMapBox();
			case BoxingPackage.STRING_TO_EOBJECT_MAP: return (EObject)createStringToEObjectMap();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case BoxingPackage.CDO_VIEW_CONTEXT:
	 ...
	 * @generated
	 */
	public <T> ListBox<T> createListBox() {
		ListBoxImpl<T> listBox = new ListBoxImpl<T>();
		return listBox;
	}
	 ...
	 * @generated
	 */
	public MapBox createMapBox() {
		MapBoxImpl mapBox = new MapBoxImpl();
		return mapBox;
	}
	...
	public CDOViewContext createCDOViewContextFromString(EDataType eDataType, String initialValue) {
		return (CDOViewContext)super.createFromString(eDataType, initialValue);
	}
