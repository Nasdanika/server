...
public class BoxingSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BoxingPackage.LIST_BOX: {
				ListBox<?> listBox = (ListBox<?>)theEObject;
				T1 result = caseListBox(listBox);
				if (result == null) result = caseBox(listBox);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case BoxingPackage.STRING_TO_EOBJECT_MAP: {
				@SuppressWarnings("unchecked") Map.Entry<String, EObject> stringToEObjectMap = (Map.Entry<String, EObject>)theEObject;
				T1 result = caseStringToEObjectMap(stringToEObjectMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public <T> T1 caseListBox(ListBox<T> object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseMapBox(MapBox object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseStringToEObjectMap(Map.Entry<String, EObject> object) {
		return null;
	}
