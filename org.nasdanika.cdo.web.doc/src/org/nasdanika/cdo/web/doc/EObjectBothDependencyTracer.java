...
/**
 * Collects inbound and outbound dependencies from EReferences of objects in the same resource set.
 * @author Pavel Vlasov
 *
 * @param <T>
 */
public class EObjectBothDependencyTracer extends DependencyTracer<EObject> {
