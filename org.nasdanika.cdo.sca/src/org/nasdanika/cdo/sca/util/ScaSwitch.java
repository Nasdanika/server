...
public class ScaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ScaPackage.COMPONENT: {
				...
				if (result == null) result = caseJSONLoader(component);
			...
			case ScaPackage.COMPOSITE: {
				...
				if (result == null) result = caseJSONLoader(composite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.WIRE: {
				...
				if (result == null) result = caseJSONLoader(wire);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.PROPERTY_SETTING: {
				PropertySetting propertySetting = (PropertySetting)theEObject;
				T result = casePropertySetting(propertySetting);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.JSON_LOADER: {
				JSONLoader jsonLoader = (JSONLoader)theEObject;
				T result = caseJSONLoader(jsonLoader);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.PROPERTY_ENTRY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Property Setting</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Property Setting</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePropertySetting(PropertySetting object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePropertyEntry(Map.Entry<String, EObject> object) {
		return null;
	}
