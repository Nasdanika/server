...
public class ScaAdapterFactory extends AdapterFactoryImpl {
	...
	protected ScaSwitch<Adapter> modelSwitch =
		new ScaSwitch<Adapter>() {
			...
			@Override
			public Adapter casePropertySetting(PropertySetting object) {
				return createPropertySettingAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.cdo.sca.Component <em>Component</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.cdo.sca.Composite <em>Composite</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.cdo.sca.Wire <em>Wire</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.cdo.sca.PropertySetting <em>Property Setting</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPropertySettingAdapter() {
		return null;
	}
