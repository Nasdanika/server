...
public class TestRenderer {
  ...
  protected final String TEXT_2 = ";" + NL + "" + NL + "import java.awt.GraphicsEnvironment;" + NL + "import java.util.concurrent.TimeUnit;" + NL + "" + NL + "import org.junit.After;" + NL + "import org.junit.Assert;" + NL + "import org.junit.Before;" + NL + "import org.junit.FixMethodOrder;" + NL + "import org.junit.Test;" + NL + "import org.junit.runner.RunWith;" + NL + "import org.junit.runners.MethodSorters;" + NL + "import ";
  protected final String TEXT_3 = ".";
  protected final String TEXT_4 = "ActorFactory;" + NL + "import ";
  protected final String TEXT_5 = ".";
  protected final String TEXT_6 = "Actor;" + NL + "import ";
  protected final String TEXT_7 = ".";
  protected final String TEXT_8 = "Page;" + NL + "import org.nasdanika.webtest.Actor;" + NL + "import org.nasdanika.webtest.ActorFactory;" + NL + "import org.nasdanika.webtest.Description;" + NL + "import org.nasdanika.webtest.NasdanikaWebTestRunner;" + NL + "import org.nasdanika.webtest.Pending;" + NL + "import org.nasdanika.webtest.Screenshot;" + NL + "import org.nasdanika.webtest.WebTest;" + NL + "import org.openqa.selenium.WebDriver;" + NL + "import org.openqa.selenium.firefox.FirefoxDriver;" + NL + "import org.openqa.selenium.phantomjs.PhantomJSDriver;" + NL + "" + NL + "@RunWith(NasdanikaWebTestRunner.class)" + NL + "@FixMethodOrder(MethodSorters.NAME_ASCENDING)" + NL + "@Description(\"Tests of ";
  ...
  protected final String TEXT_11 = "ActorFactory actorFactory;" + NL + "" + NL + "\t@Before" + NL + "\tpublic void setUp() throws Exception {" + NL + "        driver = GraphicsEnvironment.isHeadless() ? new PhantomJSDriver() : new FirefoxDriver(); // new ChromeDriver();" + NL + "        driver.manage().timeouts().pageLoadTimeout(3, TimeUnit.SECONDS);" + NL + "\t}" + NL + "\t" + NL + "\t@Test" + NL + "\t@Pending" + NL + "\t@Description(\"Test 1\")" + NL + "\t@Screenshot({Screenshot.When.AFTER, Screenshot.When.EXCEPTION})" + NL + "\tpublic void testOne() throws Exception {" + NL + "\t\t";
