...
public class TestFeaturePomRenderer {


  protected static String nl;
  public static synchronized TestFeaturePomRenderer create(String lineSeparator)
  {
    nl = lineSeparator;
    TestFeaturePomRenderer result = new TestFeaturePomRenderer();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = ".feature</artifactId>" + NL + "  <packaging>eclipse-feature</packaging>" + NL + "  <name>";
  protected final String TEXT_3 = " Tests Feature</name>" + NL + "  <parent>" + NL + "  \t<groupId>";
