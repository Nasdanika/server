...
public class TestRunnerRenderer {
  ...
  protected final String TEXT_4 = "Tests.class);" + NL + "        " + NL + "        java.awt.Toolkit.getDefaultToolkit().beep();" + NL + "        " + NL + "        //System.out.println(result);" + NL + "        " + NL + "        return EXIT_OK;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void stop() {" + NL + "\t\t// NOP" + NL + "\t}" + NL + "" + NL + "}";
