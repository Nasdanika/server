...
public class PageImplRenderer {
  ...
  protected final String TEXT_4 = "Page;" + NL + "import org.nasdanika.webtest.ReflectivePageFragmentBase;" + NL + "import org.nasdanika.webtest.Wait;" + NL + "import org.openqa.selenium.WebDriver;" + NL + "" + NL + "" + NL + "@Wait(id=\"button-groups\")" + NL + "public class ";
  protected final String TEXT_5 = "PageImpl extends ReflectivePageFragmentBase<WebDriver> implements ";
