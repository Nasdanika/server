...
public class PageImplPomRenderer {


  protected static String nl;
  public static synchronized PageImplPomRenderer create(String lineSeparator)
  {
    nl = lineSeparator;
    PageImplPomRenderer result = new PageImplPomRenderer();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = " Page Implementations</name>" + NL + "\t<parent>" + NL + "\t\t<groupId>";
