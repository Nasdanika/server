...
public class TestPluginRenderer {
  ...
  protected final String TEXT_1 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + NL + "<?eclipse version=\"3.4\"?>" + NL + "<plugin>" + NL + "   <extension" + NL + "         id=\"";
  ...
  protected final String TEXT_4 = "TestRunner\">" + NL + "         </run>" + NL + "      </application>" + NL + "   </extension>" + NL + "</plugin>";
