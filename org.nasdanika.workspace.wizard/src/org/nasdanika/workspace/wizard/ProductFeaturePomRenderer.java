...
public class ProductFeaturePomRenderer {


  protected static String nl;
  public static synchronized ProductFeaturePomRenderer create(String lineSeparator)
  {
    nl = lineSeparator;
    ProductFeaturePomRenderer result = new ProductFeaturePomRenderer();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = ".product.feature</artifactId>" + NL + "  <packaging>eclipse-feature</packaging>" + NL + "  <name>";
  protected final String TEXT_3 = " Product Feature</name>" + NL + "  <parent>" + NL + "  \t<groupId>";
