...
public class ApplicationPluginRenderer {
  ...
  protected final String TEXT_67 = NL + "   <extension" + NL + "         point=\"org.nasdanika.cdo.web.doc.extensions\">" + NL + "      <wiki-link-renderer" + NL + "            class=\"org.nasdanika.cdo.web.doc.extensions.LightboxWikiLinkRenderer\"" + NL + "            name=\"image\">" + NL + "         <description><![CDATA[" + NL + "            Renders a [lightbox](http://lokeshdhakar.com/projects/lightbox2/) image link. " + NL + "" + NL + "Example:" + NL + "" + NL + "* ``[[image:https://github.com/Nasdanika/server/wiki/webtest.png]]`` is rendered as [[image:https://github.com/Nasdanika/server/wiki/webtest.png]]" + NL + "         ]]></description>" + NL + "      </wiki-link-renderer>" + NL + "      <plugin" + NL + "            class=\"org.nasdanika.cdo.web.doc.extensions.IncludePlugin\"" + NL + "            name=\"include\">" + NL + "         <description>" + NL + "Includes content of another documentation resource into this resource." + NL + " " + NL + "Format ``{\\{include>resource location}}``. Resource location URL supports custom schemes corresponding to the names of registered wiki link resolvers, e.g. ``bundle`` schema." + NL + "" + NL + "Curly brackets and greater signs can be escaped by prepending them with backslash. The opening tag shall be escaped by placing the backslash between the first and the second opening" + NL + "curly brackets." + NL + "         </description>" + NL + "      </plugin>" + NL + "      " + NL + "      <wiki-link-resolver" + NL + "            class=\"org.nasdanika.cdo.web.doc.extensions.WikipediaResolver\"" + NL + "            name=\"wp\">" + NL + "            <description><![CDATA[" + NL + "            Resolves Wikipedia URL from the article name, renders wikipedia icon before the link. Replaces spaces with underscores in the article name. Format: ``[[wp>article name|text]]``. Example: ``[[wp>Domain-driven design]]`` is rendered as [[wp>Domain-driven design]]." + NL + "            ]]></description>" + NL + "      </wiki-link-resolver>" + NL + "         " + NL + "       <wiki-link-resolver" + NL + "            class=\"org.nasdanika.cdo.web.doc.extensions.JavadocWikiLinkResolver\"" + NL + "            name=\"javadoc\">" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.boxing\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.boxing/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.function\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.function/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.h2\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.h2/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.promise\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.promise/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.sca\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.sca/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.sca.edit\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.sca.edit/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.scheduler\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.scheduler/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.security\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.security/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.security.edit\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.security.edit/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.security.editor\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.security.editor/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.web\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.web/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo.web.doc\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.web.doc/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.cdo\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.core\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.core/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.core.tests\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.core.tests/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.function.cdo\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.function.cdo/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.function\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.function/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.html\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.html/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.sca.design\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.sca.design/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.sca.edit\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.sca.edit/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.sca.editor\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.sca.editor/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.sca\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.sca/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.tools.design\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.tools.design/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.web\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.web/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.webtest.performance\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.webtest.performance/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.webtest\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.webtest/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "         \t\tname=\"packageMap.org.nasdanika.workspace.wizard\"" + NL + "         \t\tvalue=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.workspace.wizard/target/site/apidocs\">" + NL + "         </property>" + NL + "" + NL + "         <property" + NL + "               name=\"packageMap.java\"" + NL + "               value=\"http://docs.oracle.com/javase/8/docs/api\">" + NL + "         </property>" + NL + "         " + NL + "         <property" + NL + "               name=\"packageMap.javax\"" + NL + "               value=\"http://docs.oracle.com/javase/8/docs/api\">" + NL + "         </property>" + NL + "         <description>" + NL + "            Resolves JavaDoc URL from the class/package name. Usage: ``[[javadoc&gt;fully qualified class name|text]]``. Text is optional. Examples: " + NL + "" + NL + "* ``[[javadoc&gt;java.lang.String]]`` is rendered as [[javadoc&gt;java.lang.String]]" + NL + "* ``[[javadoc&gt;java.lang.String|java.lang.String]]`` is rendered as [[javadoc&gt;java.lang.String|java.lang.String]]" + NL + "         </description>" + NL + "      </wiki-link-resolver>" + NL + "      <markdown-pre-processor class=\"org.nasdanika.cdo.web.doc.extensions.PlantUmlMarkdownPreProcessor\">" + NL + "         <description>" + NL + "             Generates UML diagrams from [PlantUML](http://plant) specifications enclosed between ``@startuml`` and ``@enduml`` tags. @startuml and @enduml tags shall be at the beginning of the line and be the only text on the line except whitespaces. @startuml shall be preceded by a blank line and @enduml shall be followed by a blank line. [GraphWiz](http://www.graphviz.org/) is required to render diagrams other than sequence diagrams. See PlantUML site for details." + NL + "" + NL + "Example:" + NL + "```" + NL + "@startuml" + NL + "A -> B : Message" + NL + "@enduml" + NL + "```" + NL + "is rendered as " + NL + "" + NL + "@startuml" + NL + "A -> B : Message" + NL + "@enduml" + NL + "         </description>" + NL + "      </markdown-pre-processor>      " + NL + "   </extension>";
