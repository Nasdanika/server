...
public class ApplicationPluginRenderer {
  ...
  protected final String TEXT_69 = "/wizard.getDocRoutePath()/bundle/";
  protected final String TEXT_70 = "/api/\"/>" + NL + "            " + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.boxing/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.function/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.h2/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.promise/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.sca/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.sca.edit/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.scheduler/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.security/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.security.edit/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.security.editor/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.web/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo.web.doc/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.cdo/target/site/apidocs/\">" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.core/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.core.tests/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.function.cdo/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.function/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.html/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.sca.design/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.sca.edit/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.sca.editor/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.sca/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.tools.design/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.web/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.webtest.performance/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.webtest/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://www.nasdanika.org/server/apidocs/org.nasdanika.workspace.wizard/target/site/apidocs\"/>" + NL + "         <property name=\"location\" value=\"http://help.eclipse.org/mars/topic/org.eclipse.emf.cdo.doc/javadoc/\"/>" + NL + "         <property name=\"location\" value=\"http://docs.oracle.com/javase/8/docs/api\"/>" + NL + "         " + NL + "         <description>" + NL + "            Resolves JavaDoc URL from the class/package name. Usage: ``[[javadoc&gt;fully qualified class name|text]]``. Text is optional. Examples: " + NL + "" + NL + "* ``[[javadoc&gt;java.lang.String]]`` is rendered as [[javadoc&gt;java.lang.String]]" + NL + "* ``[[javadoc&gt;java.lang.String|java.lang.String]]`` is rendered as [[javadoc&gt;java.lang.String|java.lang.String]]" + NL + "         </description>" + NL + "      </wiki-link-resolver>" + NL + "      <markdown-pre-processor class=\"org.nasdanika.cdo.web.doc.extensions.PlantUmlMarkdownPreProcessor\">" + NL + "         <description>" + NL + "             Generates UML diagrams from [PlantUML](http://plant) specifications enclosed between ``@startuml`` and ``@enduml`` tags. @startuml and @enduml tags shall be at the beginning of the line and be the only text on the line except whitespaces. @startuml shall be preceded by a blank line and @enduml shall be followed by a blank line. [GraphWiz](http://www.graphviz.org/) is required to render diagrams other than sequence diagrams. See PlantUML site for details." + NL + "" + NL + "Example:" + NL + "```" + NL + "@startuml" + NL + "A -> B : Message" + NL + "@enduml" + NL + "```" + NL + "is rendered as " + NL + "" + NL + "@startuml" + NL + "A -> B : Message" + NL + "@enduml" + NL + "         </description>" + NL + "      </markdown-pre-processor>      " + NL + "   </extension>";
