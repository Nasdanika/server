...
public class RouteRenderer {
  ...
  protected final String TEXT_2 = ";" + NL + "" + NL + "import org.nasdanika.web.HttpServletRequestContext;" + NL + "import org.nasdanika.web.Action;" + NL + "import org.nasdanika.web.ValueAction;" + NL + "import org.nasdanika.web.Route;" + NL + "" + NL + "/**" + NL + " * Route to demonstrate/test HTMLFactory capabilities" + NL + " *" + NL + " */" + NL + "public class ";
