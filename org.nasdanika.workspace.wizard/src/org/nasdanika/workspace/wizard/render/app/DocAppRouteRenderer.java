...
public class DocAppRouteRenderer {
  ...
  protected final String TEXT_5 = "/doc.html\")" + NL + "\t\t\t\t.style(\"margin-bottom\", \"0px\")" + NL + "\t\t\t\t.id(\"docAppPanel\");" + NL + "\t\t" + NL + "\t\tTable table = htmlFactory.table().style(\"margin-bottom\", \"0px\");" + NL + "\t\tRow row = table.row();" + NL + "\t\tDocumentationPanelFactory documentationPanelFactory = new DocumentationPanelFactory(htmlFactory, context.getContextURL()+\"/doc\") {" + NL + "" + NL + "\t\t\t@Override" + NL + "\t\t\tprotected Tag tocDiv() {" + NL + "\t\t\t\treturn super.tocDiv().style(\"overflow-y\", \"scroll\");" + NL + "\t\t\t}" + NL + "\t\t};" + NL + "\t\trow.cell(documentationPanelFactory.leftPanel()).id(\"left-panel\").style(\"min-width\", \"17em\");" + NL + "\t\trow.cell(\"\")" + NL + "\t\t\t.id(\"splitter\")" + NL + "\t\t\t.style(\"width\", \"5px\")" + NL + "\t\t\t.style(\"min-width\", \"5px\")" + NL + "\t\t\t.style(\"padding\", \"0px\")" + NL + "\t\t\t.style(\"background\", \"#d9edf7\")" + NL + "\t\t\t.style(\"border\", \"solid 1px #bce8f1\")" + NL + "\t\t\t.style(\"cursor\", \"col-resize\");" + NL + "\t\trow.cell(documentationPanelFactory.rightPanel()).id(\"right-panel\");" + NL + "\t\t\t\t" + NL + "\t\tappPanel.contentPanel(" + NL + "\t\t\t\ttable, " + NL + "\t\t\t\thtmlFactory.tag(TagName.script, getClass().getResource(\"Splitter.js\"))," + NL + "\t\t\t\thtmlFactory.tag(TagName.script, getClass().getResource(\"Scroller.js\"))," + NL + "\t\t\t\thtmlFactory.tag(TagName.script, getClass().getResource(\"SetHeight.js\")));" + NL + "\t\t" + NL + "\t\tfinal AutoCloseable app = htmlFactory.bootstrapRouterApplication(" + NL + "\t\t\t\tTheme.Default," + NL + "\t\t\t\tStringEscapeUtils.escapeHtml4(\"Documentation\"), " + NL + "\t\t\t\tnull, //\"main/doc/index.html\", " + NL + "\t\t\t\thtmlFactory.fragment(" + NL + "\t\t\t\t\t\thtmlFactory.tag(TagName.link)" + NL + "\t\t\t\t\t\t\t.attribute(\"rel\", \"stylesheet\")" + NL + "\t\t\t\t\t\t\t.attribute(\"href\", context.getContextURL()+\"/doc/resources/highlight/styles/github.css\"),\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\thtmlFactory.tag(TagName.link)" + NL + "\t\t\t\t\t\t\t.attribute(\"rel\", \"stylesheet\")" + NL + "\t\t\t\t\t\t\t.attribute(\"href\", context.getContextURL()+\"/doc/resources/css/github-markdown.css\"),\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\thtmlFactory.tag(TagName.link)" + NL + "\t\t\t\t\t\t\t.attribute(\"rel\", \"stylesheet\")" + NL + "\t\t\t\t\t\t\t.attribute(\"href\", context.getContextURL()+\"/doc/resources/jstree/themes/default/style.min.css\")," + NL + "\t\t\t\t\t\thtmlFactory.tag(TagName.script, \"\")" + NL + "\t\t\t\t\t\t\t.attribute(\"src\", context.getContextURL()+\"/doc/resources/highlight/highlight.pack.js\")), " + NL + "\t\t\t\tappPanel);" + NL + "\t\t" + NL + "\t\treturn new Action() {" + NL + "\t\t\t" + NL + "\t\t\t@Override" + NL + "\t\t\tpublic void close() throws Exception {" + NL + "\t\t\t\tapp.close();\t\t\t\t" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t@Override" + NL + "\t\t\tpublic Object execute() throws Exception {" + NL + "\t\t\t\treturn app.toString();" + NL + "\t\t\t}" + NL + "\t\t};" + NL + "\t\t" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic boolean canExecute() {" + NL + "\t\treturn true;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void close() throws Exception {" + NL + "\t\t// NOP" + NL + "\t}" + NL + "" + NL + "}";
