...
public class SessionInitializerRenderer {
  ...
  protected final String TEXT_9 = "SessionInitializerComponent implements CDOSessionInitializer {" + NL + "\t" + NL + "\t@Override" + NL + "\tpublic void init(CDOSession session) {" + NL + "\t\t// Register packages" + NL + "\t\tCDOPackageRegistry packageRegistry = session.getPackageRegistry();" + NL + "\t\tpackageRegistry.putEPackage(";
  ...
  protected final String TEXT_11 = "\");" + NL + "\t\t\tif (cRes.getContents().isEmpty()) {" + NL + "\t\t\t\t// Create initial content" + NL + "\t\t\t\t";
  protected final String TEXT_12 = " rootElement = ";
  protected final String TEXT_13 = "Factory.eINSTANCE.create";
  protected final String TEXT_14 = "();" + NL + "\t\t\t\t// TODO - configure root and add sub-elements" + NL + "\t\t\t\tcRes.getContents().add(rootElement);" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\ttransaction.commit();" + NL + "\t\t} catch (CommitException e) {" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "}";
