...
public class CDOTransactionContextRouteRenderer {
  ...
  protected final String TEXT_2 = " Transaction Context Route\">" + NL + "   <implementation class=\"org.nasdanika.cdo.web.CDOViewContextAutocloseRouteComponent\"/>" + NL + "   <property name=\"pattern\" type=\"String\" value=\"transaction(\\..+)?(/.+)?\"/>" + NL + "   <property name=\"method\" type=\"String\" value=\"*\"/>" + NL + "   <service>" + NL + "      <provide interface=\"org.nasdanika.web.Route\"/>" + NL + "   </service>" + NL + "   <reference bind=\"setContextProvider\" cardinality=\"1..1\" interface=\"org.nasdanika.cdo.CDOTransactionContextProvider\" name=\"CDOTransactionContextProvider\" policy=\"static\" unbind=\"clearContextProvider\"/>" + NL + "   <property name=\"type\" type=\"String\" value=\"root\"/>" + NL + "</scr:component>";
