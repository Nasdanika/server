...
public class CDOTransactionContextProviderRenderer {
  ...
  protected final String TEXT_3 = "CDOTransactionContextProviderComponent extends CDOTransactionContextProviderComponent<LoginPasswordCredentials> {" + NL + "" + NL + "\t@SuppressWarnings(\"unchecked\")" + NL + "\t@Override" + NL + "\tprotected ProtectionDomain<LoginPasswordCredentials> getProtectionDomain(CDOTransaction view) {" + NL + "\t\tString resourcePath = \"";
  protected final String TEXT_4 = "\";" + NL + "\t\tif (view.hasResource(resourcePath)) {" + NL + "\t\t\tCDOResource res = view.getResource(resourcePath);" + NL + "\t\t\tif (res!=null) {" + NL + "\t\t\t\tfor (EObject e: res.getContents()) {" + NL + "\t\t\t\t\tif (e instanceof ProtectionDomain) {" + NL + "\t\t\t\t\t\treturn (ProtectionDomain<LoginPasswordCredentials>) e;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn null;" + NL + "\t}" + NL + "" + NL + "}";
