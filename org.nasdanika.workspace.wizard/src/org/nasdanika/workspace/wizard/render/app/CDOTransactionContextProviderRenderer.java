...
public class CDOTransactionContextProviderRenderer {
  ...
  protected final String TEXT_3 = "CDOTransactionContextProviderComponent extends CDOTransactionContextProviderComponent<LoginPasswordCredentials> {" + NL + "" + NL + "\t@SuppressWarnings(\"unchecked\")" + NL + "\t@Override" + NL + "\tprotected ProtectionDomain<LoginPasswordCredentials> getProtectionDomain(CDOTransaction view) {" + NL + "\t\tCDOResource res = view.getResource(\"";
