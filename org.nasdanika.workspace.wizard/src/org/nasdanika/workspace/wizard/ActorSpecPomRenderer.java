...
public class ActorSpecPomRenderer {


  protected static String nl;
  public static synchronized ActorSpecPomRenderer create(String lineSeparator)
  {
    nl = lineSeparator;
    ActorSpecPomRenderer result = new ActorSpecPomRenderer();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = " Actor Specifications</name>" + NL + "\t<parent>" + NL + "\t\t<groupId>";
