...
public class RepositoryPomRenderer {
  ...
  protected final String TEXT_8 = "</id>" + NL + "\t\t\t\t\t\t</product>" + NL + "\t\t\t\t\t</products>" + NL + "\t\t\t\t\t<!-- global optional parameters (with default values) -->" + NL + "\t\t\t\t\t<installFeatures>true</installFeatures>" + NL + "\t\t\t\t\t<profile>DefaultProfile</profile>" + NL + "\t\t\t\t</configuration>" + NL + "\t\t\t</plugin>" + NL + "\t\t</plugins>" + NL + "\t</build>" + NL + "</project>";
