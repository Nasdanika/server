...
public class ModelPomRenderer {


  protected static String nl;
  public static synchronized ModelPomRenderer create(String lineSeparator)
  {
    nl = lineSeparator;
    ModelPomRenderer result = new ModelPomRenderer();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = " Model</name>" + NL + "  <parent>" + NL + "  \t<groupId>";
