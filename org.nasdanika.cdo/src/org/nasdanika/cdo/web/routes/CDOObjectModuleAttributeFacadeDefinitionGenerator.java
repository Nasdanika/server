...
public class CDOObjectModuleAttributeFacadeDefinitionGenerator implements org.nasdanika.cdo.web.routes.Generator {
  ...
  protected final String TEXT_5 = "," + NL + "set ";
  protected final String TEXT_6 = "(newValue) {" + NL + "\tvar dataEntry = data.";
  ...
  protected final String TEXT_8 = ") {" + NL + "\t\t\tdataEntry.value = newValue;" + NL + "\t\t}" + NL + "\t}" + NL + "}";
