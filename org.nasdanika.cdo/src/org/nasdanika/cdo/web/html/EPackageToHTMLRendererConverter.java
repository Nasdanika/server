...
public class EPackageToHTMLRendererConverter implements Converter<EPackage, HTMLRenderer, WebContext> {
		...
		return new HTMLRenderer() {
			...
			public String render(WebContext context, String profile, Map<String, Object> environment) throws Exception {
				...
				if (!classifiers.isEmpty()) {
					Row headerRow = classifiersTable.row().background(Color.GRAY_LIGHTER);
