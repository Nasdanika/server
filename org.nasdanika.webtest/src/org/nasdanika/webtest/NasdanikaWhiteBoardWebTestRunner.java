...
/**
 * This runner publishes results to org.nasdanika.webtest.collectors:collector extensions and components which expose 
 * {@link CollectorFactory} service.
 * @author Pavel Vlasov
 *
 */
public class NasdanikaWhiteBoardWebTestRunner extends AbstractNasdanikaWebTestRunner {
	...
	public NasdanikaWhiteBoardWebTestRunner(Class<?> klass) throws InitializationError {
		super(klass);
	}

	@Override
	protected Collector createCollector(TestResultCollector testResultCollector) throws Exception {
