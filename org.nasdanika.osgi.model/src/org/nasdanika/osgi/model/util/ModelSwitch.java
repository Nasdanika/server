...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.RUNTIME: {
				org.nasdanika.osgi.model.Runtime runtime = (org.nasdanika.osgi.model.Runtime)theEObject;
			...
			case ModelPackage.SERVICE_REFERENCE: {
	 ...
	 * @generated
	 */
	public T caseRuntime(org.nasdanika.osgi.model.Runtime object) {
		return null;
	}
