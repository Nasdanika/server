...
public class KnockoutJsModelGenerator implements org.nasdanika.cdo.web.routes.Generator {
  ...
  protected final String TEXT_34 = NL + "        ]).then(function(vResults) { " + NL + "            return vResults.reduce(function(r1, r2) { " + NL + "                return r1 && r2; " + NL + "            }, true); " + NL + "        });" + NL + "    };" + NL + "    " + NL + "    this.apply = function() {";
  ...
  protected final String TEXT_38 = NL + "    " + NL + "    if (inputData) {" + NL + "    \tthis.data = inputData;" + NL + "    }" + NL + "}";
