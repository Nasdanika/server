...
public class EOperationClosureToHTMLRendererConverter implements Converter<EOperationClosure<?>, HTMLRenderer, HttpServletRequestContext> {
	...
	@Override
	public HTMLRenderer convert(final EOperationClosure<?> source, Class<HTMLRenderer> target, HttpServletRequestContext context) throws Exception {
