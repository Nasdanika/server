...
/**
 * This is the item provider adapter for a {@link org.nasdanika.cdo.sca.Wire} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WireItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.Literals.WIRE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTypeNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Wire_typeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Wire_typeName_feature", "_UI_Wire_type"),
				 ScaPackage.Literals.WIRE__TYPE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.Literals.WIRE__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Wire_targetName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Wire_targetName_feature", "_UI_Wire_type"),
				 ScaPackage.Literals.WIRE__TARGET_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScaPackage.Literals.WIRE__PROPERTIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Wire.class)) {
			case ScaPackage.WIRE__NAME:
			case ScaPackage.WIRE__TYPE_NAME:
			case ScaPackage.WIRE__TARGET_NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ScaPackage.WIRE__PROPERTIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScaPackage.Literals.WIRE__PROPERTIES,
