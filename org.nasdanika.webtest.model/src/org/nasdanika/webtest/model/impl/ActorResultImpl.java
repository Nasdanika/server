 ...
 *   <li>{@link org.nasdanika.webtest.model.impl.ActorResultImpl#getMethods <em>Methods</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActorResultImpl extends DescriptorImpl implements ActorResult {
	...
	public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentEList<Method>(Method.class, this, ModelPackage.ACTOR_RESULT__METHODS);
		}
		return methods;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.ACTOR_RESULT__METHODS:
