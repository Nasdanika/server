...
public class ScenarioItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addContextStatesPropertyDescriptor(object);
			addActionPropertyDescriptor(object);
			addOutcomePropertyDescriptor(object);
			addOutcomeStatePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Context States feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addContextStatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_contextStates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_contextStates_feature", "_UI_Scenario_type"),
				 StoryPackage.Literals.SCENARIO__CONTEXT_STATES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Outcome State feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOutcomeStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_outcomeState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_outcomeState_feature", "_UI_Scenario_type"),
				 StoryPackage.Literals.SCENARIO__OUTCOME_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StoryPackage.Literals.SCENARIO__STEPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StoryPackage.Literals.SCENARIO__STEPS,
				 StoryFactory.eINSTANCE.createStep()));
	}
