...
/**
 * This is the item provider adapter for a {@link org.nasdanika.story.Goal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StoryPackage.Literals.GOAL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDetailsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Goal_details_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Goal_details_feature", "_UI_Goal_type"),
				 StoryPackage.Literals.GOAL__DETAILS,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
