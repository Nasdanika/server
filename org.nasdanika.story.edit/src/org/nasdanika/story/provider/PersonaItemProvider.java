...
/**
 * This is the item provider adapter for a {@link org.nasdanika.story.Persona} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonaItemProvider extends UserItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Persona_picture_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Persona_picture_feature", "_UI_Persona_type"),
				 StoryPackage.Literals.PERSONA__PICTURE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StoryPackage.Literals.PERSONA__GOALS);
		}
