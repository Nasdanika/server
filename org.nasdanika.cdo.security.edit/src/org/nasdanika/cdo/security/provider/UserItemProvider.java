...
/**
 * This is the item provider adapter for a {@link org.nasdanika.cdo.security.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider 
	...
	public String getText(Object object) {
		...
		return getString("_UI_User_type") + " " + user.isDisabled();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(User.class)) {
			case SecurityPackage.USER__DISABLED:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SecurityPackage.USER__PERMISSIONS:
