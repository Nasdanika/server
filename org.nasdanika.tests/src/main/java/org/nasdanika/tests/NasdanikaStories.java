...
public class NasdanikaStories extends JUnitStories {
    ...
    StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
            .withCodeLocation(codeLocationFromClass(NasdanikaStories.class)).withFailureTrace(true)
    ...
    public Configuration configuration() {
        return new SeleniumConfiguration().useSeleniumContext(seleniumContext)
                ...
                .useStoryLoader(new LoadFromClasspath(NasdanikaStories.class))
                .useStoryReporterBuilder(reporterBuilder);
    }

    @Override
    public InjectableStepsFactory stepsFactory() {
        ApplicationContext context = new SpringApplicationContextFactory("nasdanika-steps.xml").createApplicationContext();
