/**
 */
package org.nasdanika.cdo.promise.util;
...
public class PromiseAdapterFactory extends AdapterFactoryImpl {
	...
	protected PromiseSwitch<Adapter> modelSwitch =
		new PromiseSwitch<Adapter>() {
			@Override
			public <CR, F, R, N> Adapter casePromise(Promise<CR, F, R, N> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.cdo.promise.Promise <em>Promise</em>}'.
	 * <!-- begin-user-doc -->
