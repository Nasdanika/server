...
public class MavenActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("maven-settings"));
		toolBarManager.add(new Separator("maven-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CodegenEditorPlugin.INSTANCE.getString("_UI_MavenEditor_menu"), "org.nasdanika.codegen.mavenMenuID");
