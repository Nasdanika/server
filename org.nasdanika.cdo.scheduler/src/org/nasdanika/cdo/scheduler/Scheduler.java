...
public interface Scheduler<CR, MC extends Context, K> {
	...
	K scheduleAtFixedRate(CDOTransactionContextCommand<CR, MC, Object, Object> command, long initialDelay, long period, TimeUnit timeUnit);
	
	K scheduleWithFixedDelay(CDOTransactionContextCommand<CR, MC, Object, Object> command, long initialDelay, long delay, TimeUnit timeUnit);
