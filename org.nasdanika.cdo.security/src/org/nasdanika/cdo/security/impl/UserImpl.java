 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.cdo.security.impl.UserImpl#getMemberOf <em>Member Of</em>}</li>
 *   <li>{@link org.nasdanika.cdo.security.impl.UserImpl#getPermissions <em>Permissions</em>}</li>
 *   <li>{@link org.nasdanika.cdo.security.impl.UserImpl#isDisabled <em>Disabled</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UserImpl<CR> extends CDOObjectImpl implements User<CR> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SecurityPackage.USER___AUTHORIZE__CONTEXT_EOBJECT_STRING_STRING_MAP:
			...
			case SecurityPackage.USER___ACCEPT__PRINCIPALVISITOR:
				accept((PrincipalVisitor)arguments.get(0));
				return null;
			case SecurityPackage.USER___GET_REALM:
				return getRealm();
		}
