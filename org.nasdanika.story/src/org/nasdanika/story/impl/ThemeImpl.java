 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.story.impl.ThemeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.nasdanika.story.impl.ThemeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.nasdanika.story.impl.ThemeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.nasdanika.story.impl.ThemeImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThemeImpl extends CDOObjectImpl implements Theme {
	...
	protected EClass eStaticClass() {
		return StoryPackage.Literals.THEME;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StoryPackage.THEME__CHILDREN:
				getChildren().clear();
				getChildren().addAll((Collection<? extends Theme>)newValue);
				return;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StoryPackage.THEME___VALIDATE__DIAGNOSTICCHAIN_MAP:
