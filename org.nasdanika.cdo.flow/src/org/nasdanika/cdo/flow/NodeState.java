...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Node State</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.nasdanika.cdo.flow.FlowPackage#getNodeState()
 * @model
 * @generated
 */
public enum NodeState implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Node State</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NodeState[] VALUES_ARRAY =
		new NodeState[] {
			PASSIVE,
			ACTIVATING,
			ACTIVE,
	 ...
	 * @generated
	 */
	public static NodeState get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NodeState result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Node State</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NodeState getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NodeState result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private NodeState(int value, String name, String literal) {
		this.value = value;
		this.name = name;
