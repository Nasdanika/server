...
/**
 * This is the item provider adapter for a {@link org.nasdanika.sca.CompositeReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeReferenceItemProvider extends AbstractComponentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompositeReference_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompositeReference_target_feature", "_UI_CompositeReference_type"),
				 ScaPackage.Literals.COMPOSITE_REFERENCE__TARGET,
				 true,
				 false,
				 true,
				 null,
