 ...
 * @generated
 */
public class MavenSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MavenPackage.MAVEN_NATURE: {
				MavenNature mavenNature = (MavenNature)theEObject;
	 ...
	 * @generated
	 */
	public T1 caseMavenNature(MavenNature object) {
		return null;
	}
