 ...
 * @generated
 */
public class WorkspaceRootItemProvider extends ResourceGeneratorItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CodegenPackage.Literals.WORKSPACE_ROOT__PROJECTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WorkspaceRoot.class)) {
			case CodegenPackage.WORKSPACE_ROOT__PROJECTS:
