...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.TextReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextReferenceItemProvider extends TextGeneratorItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextReference_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextReference_ref_feature", "_UI_TextReference_type"),
				 CodegenPackage.Literals.TEXT_REFERENCE__REF,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TextReference.class)) {
			case CodegenPackage.TEXT_REFERENCE__REF:
