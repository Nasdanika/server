...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.JavaFilter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JavaFilterItemProvider extends FilterItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JavaFilter_className_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JavaFilter_className_feature", "_UI_JavaFilter_type"),
	...
	public String getText(Object object) {
		String label = ((JavaFilter<?>)object).getClassName();
